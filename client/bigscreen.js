...
var youicon = new google.maps.MarkerImage("images/we.png", null, null, new google.maps.Point(35.5, 63));
...
function onBodyLoad() {
    ...
    try
    {
		...
		$('#start-layer').click(function(){
			$('#start-layer').hide();
		});
		
		$('#top-banner').click(function(){
			$('#left-banner').toggle(300);
		});
		
		$('#left-banner').click(function(){
			service.resetrobots(function(){});
		});
